/*
    ...
    GLSC2, OpenGL, OpenGL ES loader generated by glad 0.1.33 on Mon Nov  4 21:38:06 2019.

    Language/Generator: C/C++
    Specification: gl
    APIs: gl=2.1, gles2=2.0, glsc2=2.0, gles1=1.0
    ...
    Commandline:
        --profile="compatibility" --api="gl=2.1,gles2=2.0,glsc2=2.0,gles1=1.0" --generator="c" --spec="gl" --extensions=""
    Online:
        https://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&loader=on&api=gl%3D2.1&api=gles2%3D2.0&api=glsc2%3D2.0&api=gles1%3D1.0
*/
...
#if defined(_WIN32) && !defined(GLAD_API_ENTRY) && !defined(__CYGWIN__) && !defined(__SCITECH_SNAP__)
  #define GLAD_API_ENTRY __stdcall
#endif

#ifndef GLAD_API_ENTRY
  #define GLAD_API_ENTRY
#endif
#ifndef APIENTRYP
  #define APIENTRYP GLAD_API_ENTRY*
#endif

#ifndef GLAPIENTRY
  #define GLAPIENTRY GLAD_API_ENTRY
#endif
...
GLAPI const char* gladErrorString(void);
...
struct _cl_context;
struct _cl_event;
typedef void(GLAD_API_ENTRY* GLDEBUGPROC)(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar* message, const void* userParam);
typedef void(GLAD_API_ENTRY* GLDEBUGPROCARB)(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar* message, const void* userParam);
typedef void(GLAD_API_ENTRY* GLDEBUGPROCKHR)(GLenum source, GLenum type, GLuint id, GLenum severity, GLsizei length, const GLchar* message, const void* userParam);
typedef void(GLAD_API_ENTRY* GLDEBUGPROCAMD)(GLuint id, GLenum category, GLenum severity, GLsizei length, const GLchar* message, void* userParam);
typedef unsigned short GLhalfNV;
typedef GLintptr       GLvdpauSurfaceNV;
typedef void(GLAD_API_ENTRY* GLVULKANPROCNV)(void);
