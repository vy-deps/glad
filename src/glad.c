...
static const char* errorDescription = "[no error]";

const char* gladErrorString(void) {
...
int gladLoadGL(void) {
  ...
  if (open_gl()) {
    ...
    errorDescription = "open_gl not gives success";
  }
...
int gladLoadGLLoader(GLADloadproc load) {
  ...
  if (glGetString == NULL) {
    errorDescription = "glGetString not found";
    return 0;
  }
  if (glGetString(GL_VERSION) == NULL) {
    errorDescription = "glGetString returns 0";
    return 0;
  }
  find_coreGL();
